...
$(document).on('ready page:load', () ->
  ...
  $('a[data-remote].close-question').on('ajax:success', (ev, data, status, xhr) ->
    $('div.comments-container').before('<div class="alert alert-warning"><h4>Question Closed</h4><p>This question was
      closed by <strong>' + data['closed_by'] + '</strong>. New answers cannot be added.</p></div>')
